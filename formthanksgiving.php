...
<html>
  ...
  <body>
    ...
    <?php $page ="thanksgiving"; include("globalnav.php"); ?>
            ...
            <div class="col-lg-8">
              <div class="card text-center"">
                <div class="card-header d-flex align-items-center ">
                  <!-------------youth------>
                  <h2 class="h5 display display ">Thanksgiving</h2>
                </div>
                <div class="card-block ">
                  <p>Fill in amount in thanksgiving from each service as appropriate.</p>
                    ...
                    <label class="col-md-2 form-control-label">Amount</label>
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="amount in figures"><span class="input-group-addon" >.00</span>
                        </div>
                      </div>
